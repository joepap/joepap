 ...
 * and the question-line log. Read-only: nothing in the databases is modified
 * or deleted.
 *
...
function addSheet(name, rows, note) {
...
// ---------- NEP dues-members (re-import sheet) ----------
...
// ---------- Access granted (legacy; kept for completeness) ----------
...
// ---------- Full roster snapshot (with attendance flag) ----------
